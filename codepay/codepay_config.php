 ...
 */
$configfile=ROOT_PATH ."/../Application/Common/Conf/config.php";
$dataset=include_once($configfile);

print_r($_SESSION);

define('DB_HOST', $dataset['DB_HOST']); //数据库服务器地址
define('DB_USER', $dataset['DB_USER']);  //数据库用户名
define('DB_PWD', $dataset['DB_PWD']);//数据库密码
define('DB_NAME', $dataset['DB_NAME']);  //数据库名称
define('DB_PORT', $dataset['DB_PORT']);  //数据库端口
define('DB_PREFIX',$dataset['DB_PREFIX']);  //测试数据表前缀
